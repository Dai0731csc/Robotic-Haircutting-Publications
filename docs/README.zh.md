...
除本仓库收录的论文外，我们组目前还正在开展以下与远程遥操控理发机器人系统相关的持续开发工作：

- [Client_RHCR](https://github.com/Dai0731csc/Client_RHCR)：一个面向远程遥操控理发机器人系统的客户端系统，支持浏览器端感知、标定、通信与原始位姿流传输，欢迎对这一方向感兴趣的研究者和开发者参与贡献。

我们组当前正在开展的其他持续开发工作已整理在 [../ongoing-work/README.md](../ongoing-work/README.md) 中。

## Fork 的参考项目

与本方向相关的 fork 开源项目已按类别整理在 [../related-projects/README.md](../related-projects/README.md) 中。该索引用于持续扩展与机器人理发研究相关的技术参考与开源基础。
